...
public class DateRangePaginationRequest {
    ...
    @Schema(description = "Start date and time of the range (inclusive)", example = "2024-01-01T00:00:00", required = true)
    private LocalDateTime startDate;

    @NotNull(message = "endDate is required")
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
    @Schema(description = "End date and time of the range (inclusive)", example = "2024-01-31T23:59:59", required = true)
