...
public class FulfillmentReportControllerTest {
    ...
    public void testGetPlaceToShipTime_Overall() {
        ...
        assertEquals("OVERALL", response.getBody().get(0).getGroupByValue());
    ...
    public void testGetPlaceToShipTime_InvalidGroupBy() {
        ...
        FulfillmentRequestDTO request = new FulfillmentRequestDTO(
                startDate, endDate, "INVALID_VALUE");
